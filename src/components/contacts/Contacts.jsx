...
import gmail from '../common/image/Group 63.svg'
import twitter from '../common/image/twit.svg'
          ...
          <div className="container">
            ...
            <div className="contact-info__address d-flex">
              ...
              <div className="d-flex">
                ...
                <div>
                  <p>Phone</p>
                  <p><a href="tel:+996551 00 00 00">0 551 00 00 00</a></p>
                </div>
              </div>
              <div className="d-flex">
                <img src={geo} alt="" />
                <div>
                  <p>Email</p>
                  <p><a href="mailto:arykov.azat.kg@gmail.com">email@gmail.com</a> </p>
                </div>
              </div>
            </div>
            <div className="map">
